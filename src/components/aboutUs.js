...
const AboutUs = ({ setRef }) => {
  ...
  Services provided are Labor Only (2 Movers), as well as Full
  Service Truck Moves (2 Movers + Truck). Our movers show up to both
  labor only and full service moves, fully equipped with all the
  moving equipment and blankets needed to keep your belongings safe.
  At Home-Aid we realize there is already so much to worry about on
  moving day; Could be anything from taking the kids to daycare, to
  getting the utilities switched over to the new place. Let our
